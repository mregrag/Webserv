...
: _configFile(configFilePath), _servers() 
{
}

ConfigParser::ConfigParser(const ConfigParser& other) 
: _configFile(other._configFile), _servers(other._servers)  // Vector copy constructor
{
}
...
ConfigParser& ConfigParser::operator=(const ConfigParser& other) 
{
	if (this != &other) 
	{
		...
		_servers = other._servers;  // Vector assignment operator
	}
	return *this;
}
...
{
	_servers.clear();  // Clear existing servers
...
{
	ServerConfig server;  // Create on stack
